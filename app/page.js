...
export default function RAGApp() {
  ...
  const handleFileUpload = async (e) => {
    ...
    try {
      ...
      const indexRes = await indexReq.json()
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 dark:bg-gray-950 dark:text-gray-100 p-6 transition-colors">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="flex flex-col gap-6">
          {/* Add Data */}
          <Card className="bg-white dark:bg-gray-900 border border-[#4a5d48] dark:border-[#96a793]">
            <CardHeader>
            ...
            <CardContent className="flex flex-col gap-4">
              <Textarea
                ...
                className="bg-gray-100 dark:bg-gray-800 border border-[#4a5d48]/40 dark:border-[#96a793]/40"
              />
              ...
              <Input
                ...
                className="text-sm bg-gray-100 dark:bg-gray-800 border border-[#4a5d48]/40 dark:border-[#96a793]/40"
              />
        ...
        {/* Right Column - Chat */}
          <div className="md:col-span-2">
            <Card className="h-full flex flex-col bg-white dark:bg-gray-950 border border-[#96a793]">
              <CardHeader>
                <CardTitle className="text-[#4a5d48] dark:text-[#96a793]">Chat</CardTitle>
              </CardHeader>
              <CardContent className="flex flex-col justify-between h-full">
                ...
                <div className="flex gap-2 mt-4">
                  <Input
                    ...
                    className="bg-white dark:bg-gray-900 border border-[#96a793] text-black placeholder-[#96a793] focus:ring-1 focus:ring-[#39ff14]"
                    onKeyDown={(e) => e.key === "Enter" && sendMessage()}
                  />
                  <Button
                    className="bg-[#39ff14] hover:bg-[#32e212] text-black font-semibold px-4 py-2 rounded-lg shadow-md transition"
                    onClick={sendMessage}
                  >
                    Send
                  </Button>
